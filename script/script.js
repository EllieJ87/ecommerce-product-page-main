...
//   if (event.target !== mainImage && event.target !== thumbnails) {
//     console.log("you have clicked an image!")
//     let divElement = document.createElement('div')
//     let divElementText = document.createElement('p')
//     let pElementText = document.createTextNode("This is some text")
//     divElementText.appendChild(pElementText)
